...
highlight_widget(draw, acquisition_fun_cfg.tunable_segmentation_method._segmentation_parameters.native.layout, 3, item_number=None, item_number_position="E", item_number_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
# Draw a red rectangle
draw.rectangle([35, 560, 70, 1000], outline="yellow", width=5)
draw.rectangle([35, 560, 70, 1000], outline="red", width=2)

draw.rectangle([5, 560, 275, 595], outline="white", width=5)
draw.rectangle([5, 560, 275, 595], outline="green", width=2)

pos_x, pos_y = 285, 555
font = ImageFont.truetype("arialbd.ttf", size=37)
draw.text((pos_x - 1, pos_y - 1), "< base model", fill="black", font=font)
draw.text((pos_x - 1, pos_y + 1), "< base model", fill="black", font=font)
draw.text((pos_x + 1, pos_y + 1), "< base model", fill="black", font=font)
draw.text((pos_x + 1, pos_y - 1), "< base model", fill="black", font=font)
font = ImageFont.truetype("arialbd.ttf", size=36)
draw.text((pos_x, pos_y), "< base model", fill="white", font=font)

draw.rectangle([5, 665, 275, 700], outline="white", width=5)
draw.rectangle([5, 665, 275, 700], outline="green", width=2)

pos_x, pos_y = 285, 660
font = ImageFont.truetype("arialbd.ttf", size=37)
draw.text((pos_x - 1, pos_y - 1), "< fine tuned model", fill="black", font=font)
draw.text((pos_x - 1, pos_y + 1), "< fine tuned model", fill="black", font=font)
draw.text((pos_x + 1, pos_y + 1), "< fine tuned model", fill="black", font=font)
draw.text((pos_x + 1, pos_y - 1), "< fine tuned model", fill="black", font=font)
font = ImageFont.truetype("arialbd.ttf", size=36)
draw.text((pos_x, pos_y), "< fine tuned model", fill="white", font=font)
