...
highlight_widget(draw, acquisition_fun_cfg.layout, 2, item_annotation=2, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
highlight_widget(draw, acquisition_fun_cfg.layout, (3, 4), item_annotation=None, item_annotation_position="N", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
highlight_widget(draw, acquisition_fun_cfg.layout, (11, 12), item_annotation=1, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
highlight_widget(draw, acquisition_fun_cfg.tunable_segmentation_method._segmentation_parameters.native.layout, 2, item_annotation=4, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
highlight_widget(draw, acquisition_fun_cfg.layout, 14, item_annotation=None, item_annotation_position="W", item_annotation_fontsize=36, offset_x=0, offset_y=0)
...
for c_idx in range(label_groups_mgr.labels_group_root.child(0).childCount()):
    ...
    viewer.layers["Labels edit"].data[:] = z_tmp[0, 0, ...][label_groups_mgr.labels_group_root.child(0).child(c_idx)._position]
...
highlight_widget(draw, acquisition_fun_cfg.layout, 17, item_annotation=None, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
highlight_widget(draw, acquisition_fun_cfg.tunable_segmentation_method._segmentation_parameters.native.layout, 2, item_annotation=1, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_cfg.layout, 14, item_annotation=2, item_annotation_position="N", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
