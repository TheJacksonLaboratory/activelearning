...
def highlight_tab(draw, tab_widget, item_idx,
  item_annotation=None,
  item_annotation_position=None,
  item_annotation_fontsize=36,
  offset_x=0,
  offset_y=0):
    ...
    tl = tab_bar.mapToGlobal(tab_bar.tabRect(item_idx).topLeft())
    tl_x, tl_y = tl.x() - main_window_global.x() - offset_x, tl.y() - main_window_global.y() - offset_y
    br = tab_bar.mapToGlobal(tab_bar.tabRect(item_idx).bottomRight())
    br_x, br_y = br.x() - main_window_global.x() - offset_x, br.y() - main_window_global.y() - offset_y
...
def highlight_item(draw, item, tree_widget, item_annotation=None,
  ...
  offset_y=0):
    ...
    tl = tree_widget.mapToGlobal(rect.topLeft())
    tl_x, tl_y = tl.x() - main_window_global.x() - offset_x, tl.y() - main_window_global.y() - offset_y

    rect = tree_widget.visualItemRect(item[-1])
    br = tree_widget.mapToGlobal(rect.bottomRight())
    br_x, br_y = br.x() - main_window_global.x() - offset_x, br.y() - main_window_global.y() - offset_y

    tl_x, br_x = min(br_x, tl_x), max(br_x, tl_x)
    tl_y, br_y = min(br_y, tl_y), max(br_y, tl_y)

    draw_annotation(draw, (tl_x, tl_y), (br_x, br_y), item_annotation, item_annotation_position, item_annotation_fontsize)


def crop_screenshot(screenshot, width_prop=0.6, height_prop=0.0):
...
label_groups_mgr = al_widget.widget(2)
```

```{python}
al_docked_widget = viewer.window.add_dock_widget(al_widget)
```
...
cropped_image, draw, offset_x, offset_y = crop_screenshot(screenshot, width_prop=0.6, height_prop=0.0)
...
## 3.1. Select the _Acquisition function manager_ tab
...
highlight_tab(draw, al_widget, 1, item_annotation=None, item_annotation_position=None, item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
```{python}
focus_widget = acquisition_fun_mgr.layout().itemAt(0).widget()
focus_widget.setChecked(True)

acquisition_fun_mgr.patch_sizes_mspn.sizes = {"Z": 1, "Y": 256, "X": 256}
```
...
highlight_widget(draw, acquisition_fun_mgr.layout, 0, item_annotation=1, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.layout, 2, item_annotation=2, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
```{python}
acquisition_fun_mgr.max_samples_spn.setValue(4)
```
...
highlight_widget(draw, acquisition_fun_mgr.layout, (3, 4), item_annotation=None, item_annotation_position="N", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
acquisition_fun_mgr.tunable_segmentation_method.advanced_segmentation_options_chk.setChecked(True)
acquisition_fun_mgr.tunable_segmentation_method._segmentation_parameters.channels.value = (0, 1)
acquisition_fun_mgr.tunable_segmentation_method._segmentation_parameters.model_type.value = "nuclei"
```
...
highlight_widget(draw, acquisition_fun_mgr.layout, (11, 12), item_annotation=1, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method.layout, 0, item_annotation=2, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method._segmentation_parameters.native.layout, 0, item_annotation=3, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method._segmentation_parameters.native.layout, 2, item_annotation=4, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
## 3.6. Execute the segmentation method on all image groups {#sec-segment}
...
highlight_widget(draw, acquisition_fun_mgr.layout, 14, item_annotation=None, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
The new mask will appear as "images mask (1)" since there already exists one mask that was generated automatically when running the segmentation method in step @sec-segment.
:::
...
highlight_tab(draw, al_widget, 0, item_annotation=1, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
# Select the Mask layer
viewer.layers.selection.clear()
layer = viewer.layers["images mask (1)"]
...
highlight_widget(draw, acquisition_fun_mgr.layout, 14, item_annotation=None, item_annotation_position="W", item_annotation_fontsize=36, offset_x=0, offset_y=0)
...
## 5.1. Select the _Label groups manager_ tab
...
highlight_tab(draw, al_widget, 2, item_annotation=None, item_annotation_position=None, item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
```{python}
z_tmp = zarr.open("data/Cells3D.zarr/segmentation/0", mode="r")
```
...
highlight_widget(draw, image_groups_mgr.image_groups_editor.editor_widget.layout, 16, item_annotation=2, item_annotation_position="S", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
```{python}
acquisition_fun_mgr.tunable_segmentation_method.advanced_finetuning_options_chk.setChecked(True)
acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.save_path.value = "C:/Users/Public/Documents/models"
```
...
highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method.layout, 1, item_annotation=1, item_annotation_position="E", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.native.layout, 6, item_annotation=2, item_annotation_position="NE", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
```{python}
vertical_scroll_bar = acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters_scr.verticalScrollBar()
vertical_scroll_bar.setValue(vertical_scroll_bar.maximum())
 
acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.model_name.value = "nuclei_ft"
acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.batch_size.value = 3
acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.learning_rate.value = 0.0001
```
...
highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.native.layout, 14, item_annotation=4, item_annotation_position="W", item_annotation_fontsize=30, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.native.layout, 15, item_annotation=5, item_annotation_position="W", item_annotation_fontsize=30, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method._finetuning_parameters.native.layout, 16, item_annotation=6, item_annotation_position="W", item_annotation_fontsize=30, offset_x=offset_x, offset_y=offset_y)
...
highlight_widget(draw, acquisition_fun_mgr.layout, 17, item_annotation=None, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
...
vertical_scroll_bar = acquisition_fun_mgr.tunable_segmentation_method._segmentation_parameters_scr.verticalScrollBar()
vertical_scroll_bar.setValue(vertical_scroll_bar.maximum())
...
highlight_widget(draw, acquisition_fun_mgr.tunable_segmentation_method._segmentation_parameters.native.layout, 2, item_annotation=1, item_annotation_position="W", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)

highlight_widget(draw, acquisition_fun_mgr.layout, 14, item_annotation=2, item_annotation_position="N", item_annotation_fontsize=36, offset_x=offset_x, offset_y=offset_y)
